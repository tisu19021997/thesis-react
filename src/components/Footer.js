        ...
        <Desktop>
          ...
          <div className="o-col__item">
            <ul className="o-list-bare">
              ...
              <li className="c-footer__nav-item child">Xyz Business Card</li>
              <li className="c-footer__nav-item child">Shop With Points</li>
              <li className="c-footer__nav-item child">Reload Your Balance</li>
              <li className="c-footer__nav-item child">Xyz Currency Converter</li>
            </ul>
          </div>
          ...
          <div className="o-col__item">
            <ul className="o-list-bare">
              ...
              <li className="c-footer__nav-item child">Your Account</li>
              <li className="c-footer__nav-item child">Your Order</li>
              <li className="c-footer__nav-item child">Return & Replacements</li>
